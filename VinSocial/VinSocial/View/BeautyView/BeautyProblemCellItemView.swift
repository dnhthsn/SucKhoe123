//
//  BeautyProblemCellItemView.swift
//  VinSocial
//
...
struct BeautyProblemCellItemView: View {
    var title: String
    ...
    var body: some View {
        ...
        .fullScreenCover(isPresented: $showContent, content: {
            //BeautyProblemContentView(title: title, subCatalog: subCatalog, viewModel: viewModel)
            ConcernItemView(title: title, subCatalog: subCatalog, viewModel: viewModel)
        })
    }
}
