    ...
    var body: some View {
        VStack {
            ...
            ScrollView {
                                    ...
                                    ForEach(viewModel.replyComments) {reply in
                                        if reply.comment_id == viewModel.replyComments.last?.comment_id {
                                            ReplyCell(viewModel: commentCellViewModel, reply: reply)
                                                .task { await viewModel.loadNextPageReply(act: "getComment", id: postid, cid: "", pid: commentCellViewModel.comment.comment_id ?? "", sortcomm: 1) }
                ...
                .onAppear {
                    Task{
                        await viewModel.loadFirstPageReply(act: "getComment", id: postid, cid: "", pid: commentCellViewModel.comment.comment_id ?? "", sortcomm: 1)
                    }
                }
                .onTapGesture {
                    dismissKeyboard()
            ...
            VStack {
                ...
                HStack {
                    ...
                    Image("ic_send")
                        ...
                        .onTapGesture {
                            viewModel.responseComment(act: "comment", id: postid, cid: "", pid: commentCellViewModel.comment.comment_id ?? "", reptouserid: "", content: commentText, photo_comment: selectedImageData ?? Data())
                            commentText = ""
