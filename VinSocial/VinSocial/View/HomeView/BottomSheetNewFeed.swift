...
struct BottomSheetNewFeed: View {
                ...
                VStack(spacing: 15) {
                    if AuthenViewModel.shared.currentUser?.userid == userid {
                        ...
                        .fullScreenCover(isPresented: $showEditPost, content: {
                            WritePostView(user: AuthenViewModel.shared.currentUser!, homeViewModel: HomeViewModel(), isEditPost: true, postid: postid)
                        })
                    }
