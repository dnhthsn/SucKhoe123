...
//        NavigationView {
            VStack {
                VStack {
                    HStack {
                        Text(LocalizedStringKey("Label_Image"))
                        ...
                        HStack{
                            ...
                            TextField("", text: $searchText)
                                ...
                                .onChange(of: searchText) { newValue in
                                    ...
                                    if newLength > 2 {
                                        viewModel.searchFeed(keyword: newValue, mod: "photo")
                                    }else{
                    ...
                    if (viewModel.newFeeds.isEmpty || viewModel.isLoadingSearchPage) {
                        ...
                        if viewModel.newFeedSearchs.isEmpty {
                            NewFeedsView(viewModel:viewModel,isSearching: false, showType: TypeShowScreen.PHOTO)
                        }else{
                            NewFeedsView(viewModel:viewModel,isSearching:true, showType: TypeShowScreen.PHOTO)
                        }
                    }
                }
            }
